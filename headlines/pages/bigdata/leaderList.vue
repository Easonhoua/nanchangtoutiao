<template>
	<view class="subrequirement">
		<image class="bg" src="/static/img/home/ljrwbj2.png" mode="widthFix"></image>
		...
		<view class="cellbox spokesman" style="top: 110rpx;">
			<text class="title">数字经济100人</text>
			<text class="tip">汇集南昌数字经济领域知名企业家。</text>
					...
					<view class="panel">
						<view class="spokesman-panel-con">
							...
							<view class="txtbox" @tap.stop="jumpDetail(item.id)">
								...
								<text class="txt-cut-two" style="font-size: 22rpx;color: #919191;">{{item.desc}}</text>
