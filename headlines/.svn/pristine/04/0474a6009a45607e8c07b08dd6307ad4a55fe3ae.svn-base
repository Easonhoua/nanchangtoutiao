<template>
	<view class="inquiredetails">
		...
		<view class="bg" style="margin-top: 150upx;">
			<image class="img" src="../../static/img/home/zqdh_bg.png" mode="widthFix"></image>
			<view class="main" style="width: 100%;">
				<view class="inner">
					<view class="message-btn" @click="toReleaseMessage()">
						<image class="btn" src="../../static/img/home/wytw.png"></image>
					</view>
					<view class="listbox">
		...
		methods: {
			...
			toReleaseMessage() {
				if(this.request.alreadyLogin()){
					uni.navigateTo({
						url: '/pages/inquire/replyMessage?type=11' 
					})
				}
			},
			goBack() {
